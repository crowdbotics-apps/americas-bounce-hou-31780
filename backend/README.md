...
## Project Structure
    ...
    ├── americas_bounce_hou_31780  # Django project configurations
...
1. Clone this repo and `cd americas_bounce_hou_31780`
...
2. Clone this repo and `cd americas_bounce_hou_31780`
